...
const int anchor0[6] = {3, 3, 4, 5, 6, 6};
const int anchor1[6] = {8, 8, 12, 10, 10, 13};
const int anchor2[6] = {15, 15, 17, 23, 26, 26};
                   ...
                   int32_t zp, float scale)
{
  ...
  //std::cout << "[DEBUG] threshold: " << threshold << "\n";
  //float  thres      = unsigmoid(threshold);
  //std::cout << "[DEBUG] thres: " << thres << "\n";
  int8_t thres_i8   = qnt_f32_to_affine(threshold, zp, scale);
  //std::cout << "[DEBUG] thres_i8: " << static_cast<int16_t>(thres_i8) << "\n";
  for (int a = 0; a < 3; a++) {
    for (int i = 0; i < grid_h; i++) {
      for (int j = 0; j < grid_w; j++) {
        ...
        if (box_confidence > thres_i8) {
          //std::cout << "\t[DEBUG] box_confidence: " << static_cast<int16_t>(box_confidence) << "\n";
...
int post_process(const std::string& label_path, int8_t* input0, int8_t* input1, int8_t* input2, int model_in_h, int model_in_w, float conf_threshold,
